...
#If the letter at that position matches 'guess' then reveal that
...
#Hint - Don't worry about getting the user to guess the next
#letter. We'll tackle that in step 3.
print(display)
